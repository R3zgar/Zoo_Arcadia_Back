...
final class Version20241020120058 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD first_name VARCHAR(32) NOT NULL, ADD last_name VARCHAR(64) NOT NULL');
